var size = 0;
var placement = 'point';
function categories_ZPP_ETE_2023_2(feature, value, size, resolution, labelText,
...
var style_ZPP_ETE_2023_2 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    var value = feature.get("ETE_23");
    var labelText = "";
    size = 0;
...
var style = categories_ZPP_ETE_2023_2(feature, value, size, resolution, labelText,
